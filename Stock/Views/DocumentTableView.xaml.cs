...
namespace Stock.UI.Views
{
    ...
    public partial class DocumentTableView : ITableView
    {
        ...
        private void LoadSettings()
        {
            ...
            {
                var columnWidth = string.Format("DocumentTableColumn{0}Width", i);
                DataGrid.Columns[i].Width =
                    new DataGridLength(AppSettings.GetAsDouble(columnWidth));

                var columnDisplayIndex = string.Format("DocumentTableColumn{0}DisplayIndex", i);
        ...
        private void DocumentTableView_OnLoaded(object sender, RoutedEventArgs e)
        {

...
namespace Stock.UI.Views
{
    ...
    /// </summary>
    public partial class StaffTableView : ITableView
    {
        ...
        private void LoadSettings()
        {
            ...
            {
                var columnWidth = string.Format("StaffTableColumn{0}Width", i);
                DataGrid.Columns[i].Width =
                    new DataGridLength(AppSettings.GetAsDouble(columnWidth));

                var columnDisplayIndex = string.Format("StaffTableColumn{0}DisplayIndex", i);
        ...
        private void StaffTableView_OnLoaded(object sender, RoutedEventArgs e)
        {
